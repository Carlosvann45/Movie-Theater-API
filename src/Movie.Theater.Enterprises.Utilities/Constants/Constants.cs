namespace Movie.Theater.Enterprises
{
    ...
    public static class Constants
    {
        ...
        // log messages
        public const string LOG_REGISTER_CUSTOMER = "Request recieved for register a user.";
        public const string LOG_LOG_IN_CUSTOMER = "Request recieved for log in a user.";
